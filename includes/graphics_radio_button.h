...
void set_radio_button_check(WIDGET* w,int check);//TODO
...
int get_radio_button_check(WIDGET* w);//TODO
...
void set_radio_button_callback(WIDGET* w,void(*ucallback)(WIDGET* self, void* data),void* data);//TODO

void remove_radio_button_paint_select(WIDGET* w);//TODO
void remove_radio_button_callback(WIDGET* w);//TODO
